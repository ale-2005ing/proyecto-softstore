...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 opacity-0 animate-[fadeInDown_0.6s_ease-out_forwards]">
       ...
       class="text-blue-600 hover:text-blue-700 transition-all duration-300 inline-flex items-center gap-2 font-medium hover:gap-3">
        ...
        <p class="text-slate-600 mt-2">Organiza mejor tus productos con categorías enfocadas en alimentos</p>
    </div>
    ...
    <form action="{{ route('categorias.store') }}" method="POST"
        ...
        <div class="mb-6 opacity-0 animate-[slideIn_0.5s_ease-out_0.4s_forwards]">
            ...
            <input type="text"
                ...
                placeholder="Ej: Frutas, Verduras, Carnes, Panadería...">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 opacity-0 animate-[fadeInUp_0.5s_ease-out_0.5s_forwards]">
            ...
            <p class="text-sm text-blue-700">
                Esta sección está enfocada en categorías relacionadas con <strong>alimentos</strong>.
                Puedes crear categorías como “Frutas”, “Verduras”, “Carnes”, “Panadería”, “Bebidas”, etc.
                Las categorías ayudan a organizar mejor los productos alimenticios en tu inventario.
            </p>
        </div>
