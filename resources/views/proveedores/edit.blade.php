...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 mt-4 opacity-0 animate-[fadeInDown_0.6s_ease-out_forwards]">
        <h1 class="text-3xl font-bold text-slate-800">Editar Proveedor</h1>
        <p class="text-slate-600 mt-2">Actualiza la información del proveedor</p>
    </div>
    ...
    <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST" id="formEditarProveedor"
